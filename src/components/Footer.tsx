...
function Footer() {
  const flivColor = "#2b66b1";
  const systemsColor = "#000";
          ...
          <div >
            ...
            <div className="text-sm text-slate-500">
              <p css={{ marginBottom: '1rem'}}>
                Fliv Systems is a business solutions app that provides a set of
                powerful easy-to-use tools that simplifies the data management.
                These tools have enhanced user experience according to modern
                standards. © Fliv. All rights reserved.</p>
            </div>
          </div>
        </div>
