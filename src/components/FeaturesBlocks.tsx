        ...
        <div className="py-12 md:py-20">
          ...
          >
            ...
            >
              ...
              <h3 className="h4 font-playfair-display mb-2">Built for you</h3>
              <p className="text-lg text-slate-500">
                Our applications are customized to fit your needs. It also
                scales whenever your needs grow.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-slate-500">
                Our applications have modern easy-to-use interfaces with
            ...
            >
              ...
              <p className="text-lg text-slate-500">
                Our apps are fast in both loading and runtime. It worked on any
                device from desktops to mobiles.
              </p>
            </div>
            ...
            >
              ...
              <h3 className="h4 font-playfair-display mb-2">Synchronization</h3>
              <p className="text-lg text-slate-500">
                All data are synced and saved immediately. It becomes available
                to your all devices.
              </p>
            </div>
            ...
            >
              ...
              <h3 className="h4 font-playfair-display mb-2">Flexible Plans</h3>
              <p className="text-lg text-slate-500">
                Suitable monthly/yearly subscriptions plans. With a free trial
                period to use the application.
              </p>
            </div>
            ...
            >
              ...
              <h3 className="h4 font-playfair-display mb-2">Support</h3>
              <p className="text-lg text-slate-500">
                Get a lifetime of free professional technical support. and free
